# Generated by Django 3.1.7 on 2021-04-19 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackhitfinderpar_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackhitfinderfiberpar_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackgeompar_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackdigitizerpar_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackddunpackerpar_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackddlookuptable_versions', to='core.release')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField()),
                ('remarks', models.CharField(blank=True, max_length=255, null=True)),
                ('release', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sfibersstackcalibratorpar_versions', to='core.release')),
            ],
            options={
